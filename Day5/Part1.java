...
public class Part1{
    ...
    try{
      ...
      while (input.hasNextLine()){
        ...
        for (int i = 0; i < numToMove; i++){
          moveCrate(stacks, moveFrom, moveTo);
        }
      }
  ...
  public static void moveCrate(ArrayList<ArrayList<Character>> stacks, int moveFrom, int moveTo){
    stacks.get(moveTo - 1).add(0, stacks.get(moveFrom - 1).get(0));
